...
echo " After reboot run in order:"
echo "   1. bash ~/dotfiles-sway/scripts/check-hardware.sh"
echo "   2. bash ~/dotfiles-sway/scripts/setup-kvm.sh"
echo "   3. bash ~/dotfiles-sway/scripts/setup-damian-container.sh"
echo "   4. bash ~/dotfiles-sway/scripts/setup-security-container.sh"
echo "=========================================="
